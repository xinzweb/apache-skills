...
- [ ] **Quest 0** (from `project/cloudberry/self-assessment.md`): confirm
...
- At least one of: a real PR opened, a substantive PR review left, or a
  `dev@` post sent
- A running list of skill friction points (inline notes here or a new
  section) ready to feed into the next task
- Update `project/cloudberry/self-assessment.md`'s XP/quest log to match
